import { version as version$1, unref, inject as inject$1, watch, onScopeDispose, reactive, computed, watchEffect, toRefs, isVNode, Comment, Fragment, warn, ref, provide, defineComponent as defineComponent$1, capitalize, camelize, h, getCurrentInstance as getCurrentInstance$1, toRaw, createVNode, mergeProps, readonly, shallowReactive, Suspense, nextTick, Transition, shallowRef, withDirectives, resolveDirective, isRef, toRef, Text, resolveDynamicComponent, resolveComponent, effectScope, TransitionGroup, vShow, useSSRContext, createApp, hasInjectionContext, isReactive, defineAsyncComponent, onErrorCaptured, onServerPrefetch, isReadonly, getCurrentScope, markRaw, isShallow, withCtx, createTextVNode, openBlock, createBlock, createCommentVNode } from 'vue';
import { d as useRuntimeConfig$1, $ as $fetch, h as createError$1, l as defu, w as withQuery, m as hasProtocol, p as parseURL, n as isScriptProtocol, j as joinURL, o as parseQuery, q as createHooks, r as sanitizeStatusCode, t as withTrailingSlash, v as withoutTrailingSlash } from '../nitro/node-server.mjs';
