...
import "devalue";
const registracija_vue_vue_type_style_index_0_scoped_df1cecd2_lang = "";
const _sfc_main = {
  data() {
    return {
      ime: "",
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-df1cecd2>`);
                          ...
                          _push5(ssrRenderComponent(VCardText, null, {
                            default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                              if (_push6) {
                                ...
                                _push6(`<br data-v-df1cecd2${_scopeId5}>`);
                              } else {
                                return [
                                  createVNode(VForm, {
...
const registracija = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-df1cecd2"]]);
export {
  registracija as default
};
//# sourceMappingURL=registracija-9fa5a6df.js.map
