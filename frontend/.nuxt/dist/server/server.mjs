import { effectScope, reactive, hasInjectionContext, getCurrentInstance as getCurrentInstance$1, version as version$1, unref, inject as inject$1, toRef, h, nextTick, shallowRef, shallowReactive, isReadonly, ref, markRaw, toRaw, watch, isRef, isReactive, computed, getCurrentScope, onScopeDispose, toRefs, defineComponent as defineComponent$1, resolveComponent, isShallow, Fragment, watchEffect, capitalize, isVNode, Comment, warn, provide, camelize, createVNode, mergeProps, readonly, Suspense, Transition, TransitionGroup, withDirectives, resolveDirective, vShow, Text, resolveDynamicComponent, withCtx, createTextVNode, openBlock, createBlock, createCommentVNode, useSSRContext, defineAsyncComponent, onErrorCaptured, onServerPrefetch, createApp } from "vue";
