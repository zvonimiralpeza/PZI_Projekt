import { effectScope, reactive, hasInjectionContext, getCurrentInstance as getCurrentInstance$1, version as version$1, unref, inject as inject$1, toRef, h, nextTick, shallowRef, shallowReactive, isReadonly, ref, markRaw, toRaw, watch, isRef, isReactive, computed, getCurrentScope, onScopeDispose, toRefs, defineComponent as defineComponent$1, resolveComponent, isShallow, watchEffect, capitalize, isVNode, Comment, Fragment, warn, provide, camelize, createVNode, mergeProps, readonly, Suspense, Transition, TransitionGroup, withDirectives, resolveDirective, vShow, Text, resolveDynamicComponent, withCtx, createTextVNode, openBlock, createBlock, createCommentVNode, useSSRContext, defineAsyncComponent, onErrorCaptured, onServerPrefetch, createApp } from "vue";
...
const _routes = [
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/kupovina-6ddf58e3.js").then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/login-b6271a37.js").then((m) => m.default || m)
  },
  {
    name: "Onama",
    path: "/Onama",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/Onama-f6085470.js").then((m) => m.default || m)
  },
  {
    name: "prodaja",
    path: "/prodaja",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/prodaja-9f0df157.js").then((m) => m.default || m)
  },
  {
    name: "registracija",
    path: "/registracija",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/registracija-a0f630fc.js").then((m) => m.default || m)
  },
  {
    name: "test",
    path: "/test",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/test-a08763d3.js").then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-ce9fabeb.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-a819537a.js").then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import("./_nuxt/island-renderer-6ac9948b.js").then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export {
  ...
  omit as a3,
  makeGroupProps as a4,
  useGroup as a5,
  EventProp as a6,
  makeGroupItemProps as a7,
  useLocale as a8,
  useGroupItem as a9,
  useResizeObserver as aA,
  useDisplay as aB,
  debounce as aC,
  ensureValidVNode as aD,
  mapWritableState as aE,
  VApp as aF,
  VBtn as aG,
  useUsersStore as aH,
  VSlideYTransition as aI,
  getCurrentInstanceName as aJ,
  consoleWarn as aK,
  pick as aL,
  Intersect$1 as aM,
  callEvent as aN,
  navigateTo as aO,
  VExpandXTransition as aa,
  getCurrentInstance as ab,
  defineComponent as ac,
  useSsrBoot as ad,
  MaybeTransition as ae,
  VExpandTransition as af,
  deprecate as ag,
  convertToUnit as ah,
  getPropertyFromItem as ai,
  focusChild as aj,
  destructComputed as ak,
  parseAnchor as al,
  flipSide as am,
  flipAlign as an,
  flipCorner as ao,
  ...
  refElement as as,
  IN_BROWSER as at,
  useToggleScope as au,
  makeTransitionProps as av,
  useRtl as aw,
  useRouter as ax,
  ...
  createSimpleFunctional as h,
  injectHead as i,
  propsFactory as j,
  makeDensityProps as k,
