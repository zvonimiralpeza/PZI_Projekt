...
const _routes = [
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/kupovina-6ddf58e3.mjs').then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/login-b6271a37.mjs').then((m) => m.default || m)
  },
  {
    name: "Onama",
    path: "/Onama",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/prodaja-9f0df157.mjs').then((m) => m.default || m)
  },
  {
    name: "registracija",
    path: "/registracija",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/registracija-a0f630fc.mjs').then((m) => m.default || m)
  },
  {
    name: "test",
    path: "/test",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/test-a08763d3.mjs').then((m) => m.default || m)
  }
];
...
export { wrapInArray as $, genOverlays as A, VDefaultsProvider as B, makeBorderProps as C, makeDimensionProps as D, makeElevationProps as E, makeLoaderProps as F, makeLocationProps as G, makePositionProps as H, IconValue as I, makeRouterProps as J, useBorder as K, useDimension as L, useElevation as M, useLoader as N, useLocation as O, usePosition as P, useLink as Q, Ripple as R, LoaderSlot as S, isOn as T, eventName as U, VContainer as V, deepEqual as W, useProxiedModel as X, getUid as Y, filterInputAttrs as Z, _export_sfc as _, __nuxt_component_0 as a, useTextColor as a0, useBackgroundColor as a1, matchesSelector as a2, omit as a3, makeGroupProps as a4, useGroup as a5, EventProp as a6, makeGroupItemProps as a7, useLocale as a8, useGroupItem as a9, useResizeObserver as aA, useDisplay as aB, debounce as aC, ensureValidVNode as aD, mapWritableState as aE, VApp as aF, VBtn as aG, useUsersStore as aH, VSlideYTransition as aI, getCurrentInstanceName as aJ, consoleWarn as aK, pick as aL, Intersect$1 as aM, callEvent as aN, navigateTo as aO, VExpandXTransition as aa, getCurrentInstance as ab, defineComponent as ac, useSsrBoot as ad, MaybeTransition as ae, VExpandTransition as af, deprecate as ag, convertToUnit as ah, getPropertyFromItem as ai, focusChild as aj, destructComputed as ak, parseAnchor as al, flipSide as am, flipAlign as an, flipCorner as ao, consoleError as ap, getAxis as aq, clamp as ar, refElement as as, IN_BROWSER as at, useToggleScope as au, makeTransitionProps as av, useRtl as aw, useRouter as ax, focusableChildren as ay, getNextElement as az, VRow as b, createError as c, VCol as d, entry$1 as default, VImg as e, VSpacer as f, genericComponent as g, createSimpleFunctional as h, injectHead as i, propsFactory as j, makeDensityProps as k, makeRoundedProps as l, makeComponentProps as m, makeSizeProps as n, makeTagProps as o, provideDefaults as p, makeThemeProps as q, resolveUnrefHeadInput as r, makeVariantProps as s, provideTheme as t, useRender as u, useVariant as v, useDensity as w, useRounded as x, useSize as y, VIcon as z };
